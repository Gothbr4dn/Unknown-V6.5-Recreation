...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Recreation'],
		['Saw (M.A. Jigsaw)',	'saw',				'Main Programmer of the Recreation',				'https://www.youtube.com/channel/UC2Sk7vtPzOvbVzdVTWrribQ', 	0xFFF73838],
		['Sirox',				'sirox',			'Helper',										'https://www.youtube.com/channel/UCqp6FttWJlp67vHT8n-_uKw', 		0xFF6475F3],
		[''],
		['Sex Mod'],
