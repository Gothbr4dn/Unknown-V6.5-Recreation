...
class ClientPrefs {
	...
	public static var noVideo:Bool = false;
	public static var virginMode:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.noVideo = noVideo;
		FlxG.save.data.virginMode = virginMode;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.noVideo != null) {
			noVideo = FlxG.save.data.noVideo;
		}
		if(FlxG.save.data.virginMode != null) {
			virginMode = FlxG.save.data.virginMode;
		}
